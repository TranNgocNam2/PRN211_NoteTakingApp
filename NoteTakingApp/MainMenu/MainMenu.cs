...
namespace NoteTakingApp.MainMenu
{
    public partial class MainMenu : Form
    {
        ...
        private void btnSearchPage_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnTodo_Click_1(object sender, EventArgs e)
        {
            ...
            OpenChildForm(new Forms.Todo());
        }

        private void btnDocs_Click_1(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color3);
            OpenChildForm(new Forms.Docs());
        }
